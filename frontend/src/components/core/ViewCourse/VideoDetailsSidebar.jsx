...
const VideoDetailsSidebar = ({ setReviewModal }) => {
  ...
  // let courseData = [courseSectionData];
  console.log("courseSectionData", typeof courseSectionData);
  ...
  useEffect(() => {
    const setActiveFlags = async () => {
      ...
      // console.log("videobar", videoBarActive);
    };
    setActiveFlags();
  ...
  return (
    <>
      {!courseSectionData && <div className="bg-richblack-900">Loading...</div>}
